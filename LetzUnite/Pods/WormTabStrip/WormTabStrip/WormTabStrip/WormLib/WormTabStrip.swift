...
public struct WormTabStripStylePropertyies {
    ...
    public var wormStyel:WormStyle = .BUBBLE
    /**********************
      Heights
     **************************/
    
    var kHeightOfWorm:CGFloat = 1
    
    var kHeightOfWormForBubble:CGFloat = 45
    
    var kHeightOfDivider:CGFloat = 1
    ...
    var kPaddingOfIndicator:CGFloat = 15
    ...
    public var spacingBetweenTabs:CGFloat = 15
    
    public var isWormEnable = true
    ...
    var tabItemDefaultFont:UIFont = UIFont(name: "arial", size: 21)!
    var tabItemSelectedFont:UIFont = UIFont(name: "arial", size: 21)!
    
    /*****
     colors
     ****/
    
    public var tabItemDefaultColor:UIColor = .white
    
    public var tabItemSelectedColor:UIColor = .red
    
    //color for worm
    public var WormColor:UIColor = UIColor(netHex: 0x1EAAF1)
    
    public var topScrollViewBackgroundColor:UIColor = UIColor(netHex: 0x364756)
    
    public var contentScrollViewBackgroundColor:UIColor = UIColor.gray
    
    public var dividerBackgroundColor:UIColor = UIColor.red
...
public class WormTabStrip: UIView,UIScrollViewDelegate {
    ...
    public var shouldCenterSelectedWorm = false
    ...
    //delegate
    public weak var delegate:WormTabStripDelegate?
