...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/IQActionSheetPickerView/IQActionSheetPickerView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/WormTabStrip/WormTabStrip.framework"
